...
namespace GMLAN {
    ...
    unsafe struct CANHeader {
        ...
        public override string ToString() {
            return string.Format("UNUSE(0x{4:X2}) PRIOR(0x{5:X2}) ARBID(0x{6:X4}) ECU(0x{7:X4}) - {8}", Utils.ToBin(Unused, 3), Utils.ToBin(Priority, 3), Utils.ToBin(ArbID, 13), Utils.ToBin(ECU, 13), Unused, Priority, ArbID, ECU, ECUName());
        }
